...
const TEST_DATA: Record<string, WizardState> = {
  ...
  T2: {
    ...
    photo: { url: "https://images.unsplash.com/photo-1566616213894-2d4e1baee5d8?w=400&q=80", originalUrl: "https://images.unsplash.com/photo-1566616213894-2d4e1baee5d8?w=400&q=80", sharpenedUrl: null, crop: null, filter: "none", filterId: "original", adjustments: null, backgroundRemoved: false, backgroundBlurred: false },
    background: { type: "color", color: "#FFFFFF", imageUrl: null },
