...
const TI04: TemplateConfig = {
  ...
  elements: [
    { id: "heading", type: "text", x: 40, y: 80, w: 500, h: 40, field: "heading", fontSize: 8, fontStyle: "normal", textAlign: "left" },
    { id: "labels", type: "text", x: 40, y: 130, w: 500, h: 60, field: "relationshipLabels", fontSize: 8, textAlign: "left" },
    { id: "name", type: "text", x: 40, y: 210, w: 500, h: 120, field: "name", fontSize: 22, fontWeight: "normal", fontFamily: "Pinyon Script", textAlign: "left" },
    { id: "quote", type: "text", x: 40, y: 360, w: 500, h: 280, field: "quote", fontSize: 9, fontStyle: "italic", textAlign: "left" },
    { id: "author", type: "text", x: 40, y: 660, w: 500, h: 30, field: "quoteAuthor", fontSize: 7, textAlign: "left" },
    { id: "birthDate", type: "text", x: 560, y: 420, w: 400, h: 40, field: "birthDate", fontSize: 9, textAlign: "right" },
    { id: "deathDate", type: "text", x: 560, y: 470, w: 400, h: 40, field: "deathDate", fontSize: 9, textAlign: "right" },
  ],
};
...
const TI09: TemplateConfig = {
  ...
  elements: [
    { id: "ornament", type: "ornament", x: 370, y: 20, w: 260, h: 80, fixedAsset: "/assets/ornaments/floral-divider.svg", imageFit: "contain" },
    { id: "quote", type: "text", x: 40, y: 130, w: 420, h: 650, field: "quote", fontSize: 8, fontStyle: "italic", textAlign: "left" },
    { id: "heading", type: "text", x: 510, y: 130, w: 450, h: 40, field: "heading", fontSize: 8, textAlign: "center" },
    { id: "name", type: "text", x: 510, y: 190, w: 450, h: 100, field: "name", fontSize: 18, fontWeight: "bold", textAlign: "center" },
    { id: "birthDate", type: "text", x: 510, y: 310, w: 450, h: 30, field: "birthDate", fontSize: 9, textAlign: "center" },
    { id: "deathDate", type: "text", x: 510, y: 345, w: 450, h: 30, field: "deathDate", fontSize: 9, textAlign: "center" },
    { id: "line", type: "line", x: 510, y: 400, w: 450, h: 1, lineStyle: "1px solid #ccc" },
    { id: "verse", type: "text", x: 510, y: 420, w: 450, h: 100, field: "closingVerse", fontSize: 8, fontStyle: "italic", textAlign: "center" },
    { id: "photo", type: "image", x: 560, y: 570, w: 400, h: 380, field: "photo", imageFit: "cover", imageClip: "rounded", useCrop: true },
  ],
};
